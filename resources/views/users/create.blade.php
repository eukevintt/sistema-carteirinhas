                ...
                <form x-data="{ role: 'none', option: '' }" action="{{ route('users.store') }}" method="POST"
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg shadow p-6 space-y-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <!-- Associado -->
                            <template x-if="['admin', 'management', 'member', 'none'].includes(role)">
                                <div class="space-y-3">
                                    <div class="flex items-start space-x-3">
                                        <input id="option" name="option" type="radio" x-model="option"
                                            value="new_member" class="mt-1 text-primary focus:ring-primary">
                                        <label for="new_member" class="text-gray-700">Criar um novo associado</label>
                                    </div>
                                    ...
                                    <div x-show="option === 'existing_member'">
                                        <select name="member_id" class="select2 w-full border rounded px-2 py-2">
                            ...
                            <!-- Dependente -->
                            <template x-if="role === 'dependent' || role === 'none'">
                                <div class="space-y-3">
                                    <div class="flex items-start space-x-3">
                                        <input id="option" name="option" type="radio" x-model="option"
                                    ...
                                    <div x-show="option === 'new_dependent'" class="space-y-2">
                                        ...
                                        <div>
                                            <select name="dependent_member_id"
                                    ...
                                    <div class="flex items-start space-x-3">
                                        <input id="option" name="option" type="radio" x-model="option"
                                            value="existing_dependent" class="mt-1 text-primary focus:ring-primary">
                                        <label for="existing_dependent" class="text-gray-700">Vincular a um dependente
                                            existente</label>
                                    </div>
                                    <div x-show="option === 'existing_dependent'">
                                        <select name="dependent_id" class="select2 w-full border rounded px-4 py-2">
